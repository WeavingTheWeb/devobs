...
use WeavingTheWeb\Bundle\UserBundle\Tests\Security\Core\User\User;
...
class UserData extends AbstractFixture implements OrderedFixtureInterface,  ContainerAwareInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $users = [
            [
                'username' => $this->container->getParameter('weaving_the_web_framework_extra.authorization_user'),
                'password' => $this->container->getParameter('weaving_the_web_framework_extra.authorization_password'),
